...
@Test void testConversion14() {
		...
		Cite2Urn c2urn = new Cite2Urn("urn:cite2:hmt:coll:obj1-obj2")
		assert c2c.convert(curn).toString() == c2urn.toString()
 }
@Test void testConversion15() {

	 	CiteUrn curn = new CiteUrn("urn:cite:hmt:coll.obj1.v1@12,12,12,12")
		Cite2Urn c2urn = new Cite2Urn("urn:cite2:hmt:coll.v1:obj1@12,12,12,12")
		assert c2c.convert(curn).toString() == c2urn.toString()
 }
@Test void testConversion16() {
	...
	assert shouldFail{
		...
		Cite2Urn c2urn = new Cite2Urn("urn:cite2:hmt:coll:obj1@12,12,12,12")
		assert c2c.convert(curn).toString() == c2urn.toString()
	}
 }
@Test void testConversion17() {
		...
		Cite2Urn c2urn = new Cite2Urn("urn:cite2:hmt:coll.v1:obj1")
		assert c2c.convert(curn).toString() == c2urn.toString()
 }
@Test void testConversion18() {

	 	CiteUrn curn = new CiteUrn("urn:cite:hmt:coll.obj1")
		Cite2Urn c2urn = new Cite2Urn("urn:cite2:hmt:coll:obj1")
		assert c2c.convert(curn).toString() == c2urn.toString()
 }
@Test void testConversion19() {

	 	CiteUrn curn = new CiteUrn("urn:cite:hmt:coll")
		Cite2Urn c2urn = new Cite2Urn("urn:cite2:hmt:coll:")
		assert c2c.convert(curn).toString() == c2urn.toString()
 }
