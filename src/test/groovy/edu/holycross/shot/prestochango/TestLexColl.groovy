...
*/
class TestLexColl extends GroovyTestCase {
   ...
   String schemaUrl = "http://www.homermultitext.org/hmtschemas/collections/CiteCollectionService.rng"
    ...
    @Test void testTsv() {
        ...
        String testTsvInventory = "/Users/nsmith/Desktop/testcolls.xml"
        ...
        File testOut = new File("testdata/testoutput/hmtLexOut.ttl")
        System.err.println "Begin turtleing!"
        cc.ttl(testOut)
